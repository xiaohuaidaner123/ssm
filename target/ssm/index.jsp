...
<head>
    ...
    <script
            src="res/third-party/scrollbar/jquery.mCustomScrollbar.concat.min.js"
            type="text/javascript"></script>
    <link href="frame/frame1/res/menu/menu.css" rel="stylesheet"
          type="text/css"/>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $.ajax({
                url : "request?roleId=1",
                success : function(text) {
                    var data = mini.decode(text);
                    menu.loadData(data.data);
                }
            })
...
<div class="navbar">
    ...
    <ul class="nav navbar-nav">
        ...
        <li class="icontop"><a href="#"><i
                class="fa fa-hand-pointer-o"></i><span>系统演示</span></a></li>
        <li class="icontop"><a href="#"><i
                class="fa fa-puzzle-piece"></i><span>开发文档</span></a></li>
        <li class="icontop"><a href="#"><i
                class="fa fa-sort-amount-asc"></i><span>人力资源</span></a></li>
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown"><a class="dropdown-toggle userinfo"> <img
                class="user-img" src="frame/frame1/res/images/user.jpg"/>个人资料<i
...
<div class="container">
    ...
    <div class="main">
        <div id="mainTabs" class="mini-tabs main-tabs" activeIndex="0"
             style="height: 100%;" plain="true" buttons="#tabsButtons"
             arrowPosition="side">
            <div name="index" iconCls="fa-android" title="控制台">MiniUI导航框架
            </div>
        </div>
        <div id="tabsButtons">
            <a class="tabsBtn"><i class="fa fa-home"></i></a> <a class="tabsBtn"><i
                class="fa fa-refresh"></i></a> <a class="tabsBtn"><i
                class="fa fa-remove"></i></a> <a class="tabsBtn"><i
